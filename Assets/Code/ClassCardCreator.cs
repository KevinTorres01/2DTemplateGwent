...
public class CardCreator
{
    public static List<Card> CreateCards()
    {
        ...
        SilverCard Android_17 = new SilverCard("Android 17", "Multiply", "Universe 7", "M", 8);
        ...
        SilverCard Android_18 = new SilverCard("Android 18", "DeletRivalWeek", "Universe 7", "RS", 8);
        ...
        GoldenCard Freeza = new GoldenCard("Freeza", "WeatherR", "Universe 7", "RS", 6);
        CardList.Add(Freeza);
        Clearance Genkidama = new Clearance("Genkidama", "CleanWeather");
        CardList.Add(Genkidama);
        GoldenCard Gohan = new GoldenCard("Son Gohan", "Clean", "Universe 7", "RS", 6);
        CardList.Add(Gohan);
        ...
        DecoyCard Card5 = new DecoyCard("Kuririn", "", "Universe 7", "MS", 0);
        CardList.Add(Card5);
        ...
        SilverCard Roshi = new SilverCard("Roshi Sensei", "Clean", "Universe 7", "MS", 3);
        CardList.Add(Roshi);
        SilverCard Roshi1 = DuplicateCards(Roshi);
        CardList.Add(Roshi1);
        SilverCard Roshi2 = DuplicateCards(Roshi);
        CardList.Add(Roshi2);
        GoldenCard Son_Goku = new GoldenCard("Son Goku", "DeletePowerful", "Universe 7", "R", 8);
        CardList.Add(Son_Goku);
        SilverCard Tien_Shinhan = new SilverCard("Tien Shinhan","Draw","Universe 7","MS",2);
        ...
        GoldenCard goldenCard = new GoldenCard("Veggeta", "Average", "Universe 7", "R", 7);
